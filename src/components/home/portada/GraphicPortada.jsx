const GraphicPortada = () => {
    return (
        <>
            <svg width="472" className="h-full object-fill" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path className="circleOne" d="M0 0H157.5V157.5V157.5C70.5152 157.5 0 86.9848 0 0V0Z" fill="#ED9C4E" />
                <path className="circleTwo" d="M157 0H314.5V0C314.5 86.9848 243.985 157.5 157 157.5V157.5V0Z" fill="#E46157" />
                <path d="M157 0H246V0C246 49.1533 206.153 89 157 89V89V0Z" fill="#EAE5D8" />
                <mask id="mask0_12_6" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="315" height="315">
                ...
                <mask id="mask1_12_6" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="315" height="315">
                ...
                <mask id="mask2_12_6" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="157" y="158" width="315" height="315">
                    <rect x="157" y="158" width="315" height="315" rx="157.5" fill="#D9D9D9" />
                </mask>
